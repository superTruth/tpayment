...
func GetMerchantById(db *models.MyDB, ctx echo.Context, id uint) (*Merchant, error) {
	ret := new(Merchant)
...
// 获取机构下面的商户
func QueryMerchantInAgency(db *models.MyDB, ctx echo.Context, agencyId, offset, limit uint, filters map[string]string) (uint, []*Merchant, error) {
...
// 获取账号相关的商户列表
func QueryMerchantInUser(db *models.MyDB, ctx echo.Context, offset, limit uint, filters map[string]string) (uint, []*Merchant, error) {
	var ret []*Merchant
